...
$queryf="Select * from broughtproperty";
$result=mysqli_query($con,$queryf);
$check_soldproperty=mysqli_num_rows($result)>0;
?>
<!DOCTYPE html>
        ...
        <div class="u-form u-form-1">
          <form class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-form-email u-form-group">
              <h3>Selling ID :<?php echo $row['bid']; ?></label></h3>
              <h4>Property ID of sold property is:<?php echo $row['pid']; ?></label></h4>
              <h4>Email Id of the buyer:<?php echo $row['email']; ?></label></h4>
              <h4>Payment ID of sold property is:<?php echo $row['paymentid']; ?></label></h4>
            </div>
